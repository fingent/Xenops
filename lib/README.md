...
![screen](http://git.fingent.net/girish/XenopsFramework/raw/master/doc/codescreens/structurethis.png)![screen1](http://git.fingent.net/girish/XenopsFramework/raw/master/doc/codescreens/treestructure.png)
...
![image](http://git.fingent.net/girish/XenopsFramework/raw/master/doc/codescreens/node-start.png)         
...
![socketio](http://git.fingent.net/girish/XenopsFramework/raw/master/doc/codescreens/socketcontroller.png)
...
![socketlisteners](http://git.fingent.net/girish/XenopsFramework/raw/master/doc/codescreens/socket-listeners.png)
...
```
![socketemitters](http://git.fingent.net/girish/XenopsFramework/raw/master/doc/codescreens/socket-emitter.png)
...
![views](http://git.fingent.net/girish/XenopsFramework/raw/master/doc/codescreens/view-handlers.png)
...
![alt tag](http://git.fingent.net/girish/XenopsFramework/raw/master/doc/codescreens/logger.png)
...
![client](http://git.fingent.net/girish/XenopsFramework/raw/master/doc/codescreens/client.png)  
How to use this one ?  
```
...
![screen](http://git.fingent.net/girish/XenopsFramework/raw/master/doc/codescreens/customController1.png)

### Create custom model
![model](http://git.fingent.net/girish/XenopsFramework/raw/master/doc/codescreens/customModel.png)

Drop this bits of code in models/customModel.js.
 
### Add custom controller to server.js
![handler](http://git.fingent.net/girish/XenopsFramework/raw/master/doc/codescreens/servicehandlers.png)
![servicehandler](http://git.fingent.net/girish/XenopsFramework/raw/master/doc/codescreens/handler.png)
...
![router](http://git.fingent.net/girish/XenopsFramework/raw/master/doc/codescreens/routes.png)
...
![localhost](http://git.fingent.net/girish/XenopsFramework/raw/master/doc/codescreens/localhost.png)

It is working fine. The above mentioned example is simple one. For database related method, you can check userModel.js file

![database](http://git.fingent.net/girish/XenopsFramework/raw/master/doc/codescreens/model.png)
